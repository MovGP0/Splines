...
public partial struct Trajectory2D
{
    ...
    /// <returns>Whether there is a valid launch speed</returns>
    ...
    /// <returns>Whether valid launch angles exist</returns>
    public static bool TryGetLaunchAngles(
        float gravity,
