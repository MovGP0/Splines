...
public static class Mathfs
{
    ...
    /// <summary>Returns whether two values are approximately equal.
    ...
    [Pure]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static float Csc(float angRad) => 1f / Mathf.Sin(angRad);

    /// <summary>Returns the secant of the given angle</summary>
    /// <param name="angRad">Angle in radians</param>
    [Pure]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static float Sec(float angRad) => 1f / Mathf.Cos(angRad);

    /// <summary>Returns the cotangent of the given angle</summary>
    /// <param name="angRad">Angle in radians</param>
    [Pure]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static float Cot(float angRad) => 1f / Mathf.Tan(angRad);

    /// <summary>Returns the versine of the given angle</summary>
    /// <param name="angRad">Angle in radians</param>
    [Pure]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static float Ver(float angRad) => 1 - Mathf.Cos(angRad);

    /// <summary>Returns the coversine of the given angle</summary>
    /// <param name="angRad">Angle in radians</param>
    [Pure]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static float Cvs(float angRad) => 1 - Mathf.Sin(angRad);

    /// <summary>Returns the chord of the given angle</summary>
    /// <param name="angRad">Angle in radians</param>
    [Pure]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static float Crd(float angRad) => 2 * Mathf.Sin(angRad / 2);
    ...
    [Pure]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Vector2 Floor(Vector2 value) => new Vector2(Mathf.Floor(value.X), Mathf.Floor(value.Y));
    ...
    [Pure]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Vector4 Floor(Vector4 value) => new Vector4(Mathf.Floor(value.X), Mathf.Floor(value.Y), Mathf.Floor(value.Z), Mathf.Floor(value.W));
    ...
    [Pure]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Vector2 Ceil(Vector2 value) => new Vector2(Mathf.Ceiling(value.X), Mathf.Ceiling(value.Y));

    /// <inheritdoc cref="Mathfs.Ceil(Vector2)"/>
    [Pure]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Vector3 Ceil(Vector3 value) => new Vector3(Mathf.Ceiling(value.X), Mathf.Ceiling(value.Y), Mathf.Ceiling(value.Z));

    /// <inheritdoc cref="Mathfs.Ceil(Vector2)"/>
    [Pure]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Vector4 Ceil(Vector4 value) => new Vector4(Mathf.Ceiling(value.X), Mathf.Ceiling(value.Y), Mathf.Ceiling(value.Z), Mathf.Ceiling(value.W));
    ...
    [Pure]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static float Round(float value, MidpointRounding midpointRounding = MidpointRounding.ToEven) => Mathf.Round(value, midpointRounding);

    /// <summary>Rounds the vector components to the nearest integer</summary>
    [Pure]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Vector2 Round(Vector2 value, MidpointRounding midpointRounding = MidpointRounding.ToEven) => new Vector2(Mathf.Round(value.X, midpointRounding), Mathf.Round(value.Y, midpointRounding));

    /// <inheritdoc cref="Mathfs.Round(Vector2,MidpointRounding)"/>
    [Pure]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Vector3 Round(Vector3 value, MidpointRounding midpointRounding = MidpointRounding.ToEven) => new Vector3(Mathf.Round(value.X, midpointRounding), Mathf.Round(value.Y, midpointRounding), Mathf.Round(value.Z, midpointRounding));

    /// <inheritdoc cref="Mathfs.Round(Vector2,MidpointRounding)"/>
    [Pure]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Vector4 Round(Vector4 value, MidpointRounding midpointRounding = MidpointRounding.ToEven) => new Vector4(Mathf.Round(value.X, midpointRounding), Mathf.Round(value.Y, midpointRounding), Mathf.Round(value.Z, midpointRounding), Mathf.Round(value.W, midpointRounding));

    /// <summary>Rounds the value to the nearest value, snapped to the given interval size</summary>
    [Pure]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static float Round(float value, float snapInterval, MidpointRounding midpointRounding = MidpointRounding.ToEven) => Mathf.Round(value / snapInterval, midpointRounding) * snapInterval;

    /// <summary>Rounds the vector components to the nearest value, snapped to the given interval size</summary>
    [Pure]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Vector2 Round(Vector2 value, float snapInterval, MidpointRounding midpointRounding = MidpointRounding.ToEven) => new Vector2(Round(value.X, snapInterval, midpointRounding), Round(value.Y, snapInterval, midpointRounding));

    /// <inheritdoc cref="Mathfs.Round(Vector2,float,MidpointRounding)"/>
    [Pure]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Vector3 Round(Vector3 value, float snapInterval, MidpointRounding midpointRounding = MidpointRounding.ToEven) => new Vector3(Round(value.X, snapInterval, midpointRounding), Round(value.Y, snapInterval, midpointRounding), Round(value.Z, snapInterval, midpointRounding));
    ...
    [Pure]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Vector2Int RoundToInt(Vector2 value, MidpointRounding midpointRounding = MidpointRounding.ToEven) => new Vector2Int((int)Math.Round(value.X, midpointRounding), (int)Math.Round(value.Y, midpointRounding));

    /// <inheritdoc cref="Mathfs.RoundToInt(Vector2,MidpointRounding)"/>
    [Pure]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Vector3Int RoundToInt(Vector3 value, MidpointRounding midpointRounding = MidpointRounding.ToEven) => new Vector3Int((int)Math.Round(value.X, midpointRounding), (int)Math.Round(value.Y, midpointRounding), (int)Math.Round(value.Z, midpointRounding));
    ...
    {
        Vector2 center = a.Center().ToVector2().LerpUnclamped(b.Center().ToVector2(), t);
        Vector2 size = a.Size.ToVector2().LerpUnclamped(b.Size.ToVector2(), t);

        // offset center by size
        var location = center - size / 2;

        return new Rect(location.ToPoint(), size.ToSize());
    }
    ...
    public static float Remap(
        ...
        float oMin,
        float oMax,
        float value) => Lerp(oMin, oMax, InverseLerp(iMin, iMax, value));
    ...
    public static float Remap(
        ...
        float oMin,
        float oMax,
        int value) => Lerp(oMin, oMax, InverseLerp(iMin, iMax, value));
...
*/
    ...
    [Pure]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static float WeightedSum(
        Vector3 w,
        float a,
        float b,
        float c) => a * w.X + b * w.Y + c * w.Z;
    ...
    public static float WeightedSum(
        ...
        float b,
        float c,
        float d) => a * w.X + b * w.Y + c * w.Z + d * w.W;
    ...
    [Pure]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Vector2 WeightedSum(
        Vector2 w,
        Vector2 a,
        Vector2 b) => a * w.X + b * w.Y;
    ...
    public static Vector2 WeightedSum(
        ...
        Vector2 b,
        Vector2 c,
        Vector2 d) => a * w.X + b * w.Y + c * w.Z + d * w.W;
    ...
    [Pure]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Vector3 WeightedSum(
        Vector3 w,
        Vector3 a,
        Vector3 b) => a * w.X + b * w.Y;
    ...
    public static Vector3 WeightedSum(
        ...
        Vector3 b,
        Vector3 c,
        Vector3 d) => a * w.X + b * w.Y + c * w.Z + d * w.W;
    ...
    [Pure]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Vector4 WeightedSum(
        Vector4 w,
        Vector4 a,
        Vector4 b) => a * w.X + b * w.Y;
    ...
    public static Vector4 WeightedSum(
        ...
        Vector4 b,
        Vector4 c,
        Vector4 d) => a * w.X + b * w.Y + c * w.Z + d * w.W;
    ...
    {
        // Assuming a third vector c as [0, 0, 1] to complete a 3x3 matrix
        Vector3 c = new Vector3(0, 0, 1);

        // Calculating the determinant of the 3x3 matrix formed by vectors a, b, and c
    ...
    [Pure]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Vector3 AverageDir(Vector3 aDir, Vector3 bDir)
    ...
    public static float DistanceSquared(Vector4 a, Vector4 b)
        => (a.X - b.X).Square() + (a.Y - b.Y).Square() + (a.Z - b.Z).Square() + (a.W - b.W).Square();
    ...
    /// <remarks>Source: <a href="https://www.microsoft.com/en-us/research/wp-content/uploads/2016/12/Computation-of-rotation-minimizing-frames.pdf">
    /// Computation of Rotation Minimizing Frames</a></remarks>
    public static Vector3 GetRotationMinimizingNormal(
        Vector3 posA,
        Vector3 tangentA,
        Vector3 normalA,
        Vector3 posB,
    ...
    [Pure]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Pose PointDirToPose(Vector2 pt, Vector2 v)
        => new Pose(pt.ToVector3(), DirToOrientation(v));
    ...
    public static Pose Lerp(Pose a, Pose b, float t) =>
        new Pose(
            Vector3Extensions.LerpUnclamped(a.Position, b.Position, t),
            QuaternionExtensions.SlerpUnclamped(a.Rotation, b.Rotation, t)
       );
    ...
    public static Quaternion GetArcOrientation(Vector3 velocity, Vector3 acceleration) {
        ...
        return QuaternionExtensions.LookRotation(velocity, binormal);
    }
    ...
    public static Quaternion GetArcOrientation(Vector2 velocity, Vector2 acceleration)
    {
        ...
        return QuaternionExtensions.LookRotation(velocity.ToVector3(), binormal);
    }
    ...
    public static Quaternion GetFrenetSerretOrientation(Vector3 velocity, Vector3 acceleration)
    {
        ...
        return QuaternionExtensions.LookRotation(B, N);
    }
    ...
    [Pure]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static void GetCurvatureOrientationAxes(
        Vector3 velocity,
    ...
    [Pure]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Quaternion GetLookRotation2D(Vector2 forward, Vector2 up)
    {
        int sign = Determinant(forward, up) >= 0 ? 1 : -1;
        Vector2 Y = new(-sign * forward.Y, sign * forward.X);
        Vector3 Z = new(0, 0, sign);
        return QuaternionExtensions.LookRotation(Z, Y.ToVector3());
    }
