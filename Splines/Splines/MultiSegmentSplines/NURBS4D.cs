...
/// <summary>
/// Represents a Non-Uniform Rational B-Spline (NURBS) curve in 4D space.
/// </summary>
public sealed partial class NURBS4D
{
    /// <summary>
    ...
    /// <returns>A new instance of the <see cref="NURBS4D"/> class representing a uniform B-Spline.</returns>
    public static NURBS4D GetUniformBSpline(Vector4[] points, int degree = 3, bool open = true)
    {
        int ptCount = points.Length;
        float[] knots = SplineUtils.GenerateUniformKnots(degree, ptCount, open);
        return new NURBS4D(points, knots, null, degree);
    }
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="NURBS4D"/> class.
    /// </summary>
    ...
    public NURBS4D(Vector4[] points, float[] knots, float[]? weights, int degree = 3)
    {
    ...
    public Vector4 GetPointByKnotValue(float t)
    {
