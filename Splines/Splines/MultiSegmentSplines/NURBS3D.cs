...
/// <summary>
/// Represents a Non-Uniform Rational B-Spline (NURBS) curve in 3D space.
/// </summary>
public sealed partial class NURBS3D
{
    /// <summary>
    ...
    /// <returns>A new instance of the <see cref="NURBS3D"/> class representing a uniform B-Spline.</returns>
    public static NURBS3D GetUniformBSpline(Vector3[] points, int degree = 3, bool open = true)
    {
        int ptCount = points.Length;
        float[] knots = SplineUtils.GenerateUniformKnots(degree, ptCount, open);
        return new NURBS3D(points, knots, null, degree);
    }
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="NURBS3D"/> class.
    /// </summary>
    ...
    public NURBS3D(Vector3[] points, float[] knots, float[]? weights, int degree = 3)
    {
    ...
    public Vector3 GetPointByKnotValue(float t)
    {
