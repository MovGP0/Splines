...
public partial struct Ray2D : IEquatable<Ray2D>
{
    /// <summary>
    ...
    [Pure]
    public override bool Equals(object? obj) => obj is Ray2D ray && Equals(ray);

    /// <summary>
    /// Determines whether the specified <see cref="Ray2D"/> is equal to the current <see cref="Ray2D"/>.
    /// </summary>
    ...
    /// <summary>
    /// Determines whether two specified instances of <see cref="Ray2D"/> are equal.
    /// </summary>
    ...
    /// <summary>
    /// Determines whether two specified instances of <see cref="Ray2D"/> are not equal.
    /// </summary>
    /// <param name="left">The first ray to compare.</param>
    /// <param name="right">The second ray to compare.</param>
