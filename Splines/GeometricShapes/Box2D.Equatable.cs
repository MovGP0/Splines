...
public partial struct Box2D : IEquatable<Box2D>
{
    ...
    [Pure]
    public bool Equals(Box2D other) => Center.Equals(other.Center) && Extents.Equals(other.Extents);
    ...
    [Pure]
    public override bool Equals(object? obj) => obj is Box2D other && Equals(other);
    ...
    /// <summary>
    /// Determines whether two specified instances of Box2D are equal.
    /// </summary>
    ...
    /// <summary>
    /// Determines whether two specified instances of Box2D are not equal.
    /// </summary>
    /// <param name="left">The first box to compare.</param>
    /// <param name="right">The second box to compare.</param>
