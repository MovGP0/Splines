...
/// <summary>
/// A 3x1 column matrix with Vector2 values.
/// </summary>
[Serializable]
public struct Vector2Matrix3x1 : IEquatable<Vector2Matrix3x1>
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="Vector2Matrix3x1"/> struct.
    /// </summary>
    ...
    public Vector2Matrix3x1(Vector2 m0, Vector2 m1, Vector2 m2)
        => (M0, M1, M2) = (m0, m1, m2);

    /// <summary>
    /// Initializes a new instance of the <see cref="Vector2Matrix3x1"/> struct from two <see cref="Matrix3x1"/> instances.
    /// </summary>
    ...
    public Vector2Matrix3x1(Matrix3x1 x, Matrix3x1 y)
        => (M0, M1, M2) = (new Vector2(x.M0, y.M0), new Vector2(x.M1, y.M1), new Vector2(x.M2, y.M2));
    ...
    /// </summary>
    /// <param name="a">The first <see cref="Vector2Matrix3x1"/>.</param>
    /// <param name="b">The second <see cref="Vector2Matrix3x1"/>.</param>
    /// <param name="t">The value to blend by.</param>
    /// <returns>The interpolated <see cref="Vector2Matrix3x1"/>.</returns>
    [Pure]
    public static Vector2Matrix3x1 Lerp(Vector2Matrix3x1 a, Vector2Matrix3x1 b, float t)
        => new(a.M0.LerpUnclamped(b.M0, t), a.M1.LerpUnclamped(b.M1, t), a.M2.LerpUnclamped(b.M2, t));

    /// <summary>
    /// Determines whether two specified instances of <see cref="Vector2Matrix3x1"/> are equal.
    /// </summary>
    /// <param name="a">The first <see cref="Vector2Matrix3x1"/> to compare.</param>
    /// <param name="b">The second <see cref="Vector2Matrix3x1"/> to compare.</param>
    /// <returns><c>true</c> if the two instances are equal; otherwise, <c>false</c>.</returns>
    [Pure]
    public static bool operator ==(Vector2Matrix3x1 a, Vector2Matrix3x1 b) => a.M0 == b.M0 && a.M1 == b.M1 && a.M2 == b.M2;

    /// <summary>
    /// Determines whether two specified instances of <see cref="Vector2Matrix3x1"/> are not equal.
    /// </summary>
    /// <param name="a">The first <see cref="Vector2Matrix3x1"/> to compare.</param>
    /// <param name="b">The second <see cref="Vector2Matrix3x1"/> to compare.</param>
